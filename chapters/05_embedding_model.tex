%==============================================================
%  Embedding-Based Item-to-Item Recommendation
%==============================================================
...
present the model itself (a hierarchical cosine-softmax objective), two
extensions to it (trainable centroids and a flat alternative), its
implementation, and a sequence of controlled training experiments together with
what they reveal.
...
\begin{equation}
  ...
  \frac{\partial\ell(i,j)}{\partial e_i}
    ...
    &\quad + \Big(\sum_{k\in P_{M_j}} p_{\text{prod}}(k\mid i,M_j)\,e_k - e_j\Big),
  \end{aligned}
\end{equation}
...
over $50$ epochs, from an epoch-1 value of $13.234$ to the converged $13.204$ of
Table~\ref{tab:emb-furniture}, whereas the flat run moved it by $0.300$ over $30$
epochs, from $12.654$ to $12.354$ --- with the epoch-1 flat loss already below
the hierarchical run's converged value. At convergence the flat model
