...
\noindent The progression across the three methods tells a clean story. ALS,
...
both issues at once, and is the method we carry forward. Together with the
factorized $K$-step identity of \eqref{eq:factored-power}, it yields a
$K$-step Markov-chain recommender that is both faithful to the probabilistic
semantics of the data and feasible at IndiaMART scale.
